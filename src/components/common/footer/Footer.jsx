      ...
      <footer>
        <div className='container'>
          ...
          <div className='box'>
            <h3>SPORT</h3>
            <div className='item'>
              <img src='/news-website/images/hero/hero1.png' alt='Emergency Movie news' />
              <p>Emergency Movie: కంగనా రనౌత్ కు బిగ్ రిలీఫ్..'ఎమర్జెన్సీ' రిలీజ్ కు గ్రీన్ సిగ్నల్.. కానీ ?</p>
            </div>
            <div className='item'>
              <img src='/news-website/images/hero/hero2.png' alt='OTT Movie news' />
          ...
          <div className='box'>
            <h3>CRICKET</h3>
            <div className='item'>
              <img src='/news-website/images/hero/hero3.png' alt='Vinayakan Arrest news' />
              <p>Actor Vinayakan: ఎయిర్ పోర్ట్ లో 'జైలర్' నటుడు వినాయకన్ అరెస్ట్.. ఏం జరిగిందంటే</p>
            </div>
            <div className='item'>
              <img src='/news-website/images/hero/hero4.png' alt='Viral Video news' />
